...
public interface MAuthMapper extends BaseMapper<MAuth> {
	...
	@Select("select mr.id,mr.auth_name authName,mr.remark,mr.state,mr.update_time updateTime from m_auth mr,role_auth ur where mr.id = ur.auth_id and ur.role_id=#{}")
